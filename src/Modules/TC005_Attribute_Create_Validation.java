...
import Actions.Attribute_Page_Actions;
import Actions.Login_Page_Actions;
import Utility.Constant;
import Utility.ExcelUtils;
import Utility.GenericWrappers;

public class TC005_Attribute_Create_Validation extends GenericWrappers
{
	@BeforeClass
	public void PageDescription()
	{
		testCaseName	= "Attribute Page";
		testDescription	= "Attribute Create and Validation Check";
	}
...
//		Attribute_Page_Actions.AttributeDelete(driver, ExcelUtils.getCellData(3, 0));
	}
}
